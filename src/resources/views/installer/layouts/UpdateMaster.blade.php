    ...
    <body>
        <div class="master">
            <div class="box">
                ...
                <div class="copyright"> Copyright © 2023 <a href="javascript:void(0);">Uhelp</a>. Developed by <a href="javascript:void(0);"> Spruko Technologies Pvt.Ltd. </a> All rights reserved </div>
            </div>
        </div>
    </body>
</html>